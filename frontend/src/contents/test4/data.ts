...
const sideMenuItems: SideMenuItem[] = [
  { icon: Pencil, text: 'MenuTitle16', link: '/test16', theme: 'white' },
  { icon: Pencil, text: 'MenuTitle17', link: '/test17', theme: 'white' },
  { icon: Pencil, text: 'MenuTitle18', link: '/test18', theme: 'white' },
  { icon: Pencil, text: 'MenuTitle19', link: '/test19', theme: 'white' },
  { icon: Pencil, text: 'MenuTitle20', link: '/test20', theme: 'white' },
]
