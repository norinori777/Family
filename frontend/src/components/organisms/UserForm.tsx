            ...
            <Controller
              ...
              render={({ field }) => (
                <TextboxInHookForm
                  ...
                  theme={"primary"}
                  error={
                   errors.name && errors.name?.type === "required" ? "名前は必須です。" : "" + 
                   errors.name && errors.name?.type === "maxLength" ? "名前は10文字以内で入力してください。" : ""
                  }
                />
              )}
            />
            <Controller
              ...
              render={({ field }) => (
                <TextboxInHookForm
                  ...
                  theme={"primary"}
                  error={
                    errors.password && errors.password.type === "required" ? "パスワードは必須です。" : "" +
                    errors.password && errors.password?.type === "maxLength" ? "パスワードは20文字以内で入力してください。" : ""}
                />
              )}
            />
            <Controller
              ...
              render={({ field }) => (
                <TextboxInHookForm
                  ...
                  theme={"primary"}
                  error={
                    errors.emailAddress && errors.emailAddress.type === "required" ? "メールアドレスは必須です。" : "" +
                    errors.emailAddress && errors.emailAddress?.type === "maxLength" ? "メールアドレスは255文字以内で入力してください。" : "" }
                />
              )}
            />
